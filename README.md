...
本项目开发时间远早于相应宿舍区硬件更新的时间，不针对任何实体与个人，仅用于学习。除自动二维码发送功能外，其余所有文件(包括但不仅限于HHBT-NEWIFI3D2-BREED.ZIP&HHBT_VM_IKUAI.ZIP& HHBT_OPENWRT.ZIP内的文件)与功能已于**2024年4月20日**前学习计算机网络时完成开发，本项目也不包含单线多拨或VPN等可能存在安全隐患的代码
